(function (window, document) {
    ...
    SliderBar.prototype = {
        ...
        cutImg: function () {
            ...
            // ？图片剪切区域超过图片区域？问题之处
            // left，math.floor向下取整 ，math.random随机取大于等于0小于1的
            _this.resultX = Math.floor(Math.random() * 190 + 10);
            // Math.floor(Math.random() * (_this.imgWidth - cutWidth*2 - 4) + cutWidth);
            // top
            var cutTop = Math.floor(Math.random() * 70 + 10);
            // Math.floor(Math.random() * (_this.imgHeight - cutHeight*2) + cutHeight);
            // 设置样式
        ...
        mousedown: function (_this, e) {
            ...
            function mouseup() {
                ...
                if(_this.resultX > (left - 4) && _this.resultX < (left + 4)){
                    _this.isSuccess = true;
